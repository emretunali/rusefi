/**
 * @file boards/spark-ems/amiral/board_configuration.cpp
 *
 * @brief Configuration defaults for the Spark EMS Amiral board
 *
 * Hardware base: Hellen Mega-Module 176 (AlphaX-8chan derived open hardware).
 * Derived from firmware/config/boards/hellen/alphax-8chan/board_configuration.cpp.
 *
 * Original authors:
...
static void amiral_boardInitHardware() {
...
static void amiral_boardConfigOverrides() {
	hellenMegaModule();
	setHellenCan();
	setHellenCan2();
}
...
static void amiral_defaultConfiguration() {
	setInjectorPins();
	setIgnitionPins();
...
static bool applyAmiralBasicConfiguration(BasicConfigurationAction action) {
...
void setup_custom_board_overrides() {
	custom_board_InitHardware = amiral_boardInitHardware;
	custom_board_DefaultConfiguration = amiral_defaultConfiguration;
	custom_board_ConfigOverrides = amiral_boardConfigOverrides;
	custom_board_applyBasicConfiguration = applyAmiralBasicConfiguration;
